            ...
            <div class="row row20">
                <div class="col-4 step-card">
                    <div class="step-img radius10 position-relative overflow-hidden card-hover dmb-20">
                        <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2024/07/treding-img3.png" alt=""
    ...
    <section class="project-card-section">
        <div class="container">
            <div class="row dmb-55">
                <div class="col-3"></div>
                <div class="col-6">
                    <div class="bodoni font50 leading55 text-black text-center text-capitalize">Latest Projects
                    </div>
                </div>
                <div class="col-3">
    ...
    <section class="product-section ">
        <div class="container">
            <div class="position-relative">
                <div class="bodoni font40 leading48 text-black text-center dmb-60">Latest Commercial Furniture</div>
                <div
