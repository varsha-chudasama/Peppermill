...
<main>
            ...
            <div class="container w-100 h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-8 ms-5 ps-5">
                        <div class="mont-semibold font11 leading20 space1_65 text-white text-uppercase dmb-45">
                            INSPIRATION</div>
                        <div class="bodoni font65 leading85 text-white dmb-10">The ultimate homemaker.</div>
    ...
    <section class="collection-card-section">
        <div class="container">
            <div class="col-7 mx-auto dmb-50">
                <div class="bodoni font40 leading45 text-center text-black dmb-25">
                    Explore collections
                </div>
                <div class="mont-medium font13 leading24 text-center text-7D7D7D">
                    Explore our buying guide to find the right design and style for furnishing your home.
                </div>
            </div>
            <div class="row row10">
                <div class="col-6 dmb-20 cards-col">
                    <a href="" class="w-100 text-decoration-none">
                        <div class="collection-cards w-100 radius10 position-relative overflow-hidden  card-hover">
                            ...
                            <div
                                ...
                                <div class="bodoni font40 leading45 text-white dmb-10">
                                    Seating
                                </div>
                                <div class="mont-medium font14 leading24 text-white dmb-15">
                                    The UK’s finest selection of domestic, bar and restaurant furniture
                                </div>
                                <div class="d-inline-flex">
                                    <div class="mont-medium font13 leading24 text-white text-capitalize border-bottom">
                                        Shop
                                        Collection</div>
                                </div>
                            </div>
    ...
    <section class="banner-section position-relative">
        ...
        <div class="position-absolute top-center start-0 w-100">
            <div class="container w-100">
                <div class="col-8 ms-5 ps-5">
                    <div class="bodoni font60 leading70 text-capitalize text-white dmb-10">Seasonal Promotion</div>
    ...
    <section class="blog-card-section">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center dmb-25">
                <div class="bodoni font40 leading48 text-black text-capitalize">Blog inspiration</div>
                <a href=""
