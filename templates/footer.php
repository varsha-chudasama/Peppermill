    ...
    <div class="top-footer dpt-40">
        <div class="container">
            ...
            <div class="footer-slider dpb-50">
                <div class="footer-img radius10 overflow-hidden position-relative card-hover">
            ...
            <div class="row dpb-130">
                ...
                <div class="col-6">
                    <div class="col-8 ms-auto">
                        ...
                        <div class="mont-medium font13 leading20 text-white dmb-20">Don’t miss out on our latest
                            arrivals,
                        ...
                        <div class="mont-medium font11 leading16 text-white dmb-15">What would you like to receive?
                        </div>
            ...
            <div class="row">
                <div class="col-4">
                    <ul class="d-flex list-none footer-ul mb-0 px-0">
                        <li class="me-4"><a href="" class="d-inline-block footer-icon"><img
