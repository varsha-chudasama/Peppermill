...
<main>
  <section class="hero-section position-relative w-100">
    <div class="home-hero-img h-100 position-relative">
      <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2024/07/hero-img.png" class="w-100 h-100 object-cover" alt="">
    ...
    <div class="position-absolute top-center start-0 w-100 text-center hero-content">
        <div class="container w-100">
          <div class="col-8 mx-auto">
            <div class="montserrat-semibold font11 leading20 space1_65 text-uppercase text-white dmb-30">WELCOME TO PEPPERMILL</div>
            <div class="bodoni font75 leading90 text-white dmb-35">Spice up the ordinary.</div>
      <div class="montserrat-medium font14 leading18 text-white dmb-25">The UK’s finest selection of domestic, bar and restaurant furniture</div>
      <div class="d-flex align-items-center justify-content-center">
        <a href="" class="text-decoration-none btnA white-border-btn d-inline-block montserrat-semibold font11 leading20 space0_28 text-uppercase radius5 d-flex align-items-center justify-content-center transition">
          SHOP NOW
        </a>
      </div>
    </div>
        ...
        <div class="col-4 header-card-col dmt-20">
          <a href="" class="d-flex justify-content-center text-decoration-none card-hover radius10 overflow-hidden position-relative">
            <div class="the-ultimate-card overflow-hidden position-relative">
              <img src="<?php echo get_home_url() ?>/wp-content/uploads/2024/07/ultimate-card-img.png" class="w-100 h-100 object-cover img" alt="">
            ...
            <div class="position-absolute top-center text-center">
              ...
              <div class="d-flex align-items-center justify-content-center">
                   <button class="text-decoration-none btnA white-border-btn d-inline-block montserrat-semibold font11 leading20 space0_28 text-uppercase radius5 d-flex align-items-center justify-content-center transition">
                   SHOP NOW
                   </button>
              </div>
            </div>
      ...
      <div class="product-slider">
        <a href="" class="d-inline-block text-decoration-none card-hover">
          <div class="product-img position-relative radius10 overflow-hidden dmb-25">
            ...
            <div class="montserrat-medium font13 leading20 text-292929 bg-white radius5 position-absolute top-0 start-0 py-1 px-2 mt-3 ms-4">New in</div>
            <div class="like-img position-absolute bottom-0 end-0 me-3 mb-2">
              <img src="<?php echo get_home_url() ?>/wp-content/uploads/2024/07/like.svg" class="w-100" alt="">
            </div>
          </div>
          <div class="product-content">
            <div class="montserrat-medium font16 leading20 text-black dpb-10">Gardena Sheepskin Armchair</div>
            <div class="montserrat-medium font13 leading20 text-7D7D7D">£995.00</div>
          </div>
        </a>
        <a href="" class="d-inline-block text-decoration-none card-hover">
          <div class="product-img position-relative radius10 overflow-hidden dmb-25">
  ...
  <section class="room-card-section bg-292929 dpt-80 dpb-70">
      <div class="container">
        <div class="bodoni font45 leading54 text-capitalize text-white text-center dpb-50">Shop By Room</div>
        <div class="room-card-slider">
            <a href="" class="d-inline-block text-decoration-none card-hover">
              <div class="room-card-img overflow-hidden radius10 position-relative">
                <img src="<?php echo get_home_url() ?>/wp-content/uploads/2024/07/our-img2.png" class="h-100 w-100 object-cover img" alt="">
                ...
                <div class="position-absolute bottom-0 ps-5">
                  ...
                  <div class="montserrat-medium font13 leading20 text-white text-capitalize text-decoration-underline dpb-55">Shop Collection</div>
                </div>
              </div>
            </a>
            <a href="" class="d-inline-block text-decoration-none card-hover">
  ...
  <section class="banner-section position-relative">
      <div class="banner-img">
        <img src="<?php echo get_home_url() ?>/wp-content/uploads/2024/07/hero-img.png" alt="" class="h-100 w-100 object-cover">
      </div>
      <div class="position-absolute top-center start-0 w-100">
       <div class="container w-100">
       <div class="bodoni font60 leading72 text-capitalize text-white dmb-10">Our Showroom</div>
       <div class="col-8">
       <div class="montserrat-medium font14 leading18 text-white dmb-35">The UK’s finest selection of domestic, bar and restaurant furniture</div>
